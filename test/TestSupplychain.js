...
contract('SupplyChain', function(accounts) {
	...
	//const productPrice = web3.utils.toWei("1", "ether") //v.5
    //var itemState = 0
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
		...
		*/
        ...
        assert.equal(resultBufferOne[2], originFarmerID, 'Error: Missing or Invalid ownerID') //here ownerID is the Farmer
